...
htmlhelp_basename = 'ghc-compiler-notesdoc'
...
man_pages = [
    (master_doc, 'ghc-compiler-notes', 'ghc-compiler-notes Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'ghc-compiler-notes', 'ghc-compiler-notes Documentation',
     author, 'ghc-compiler-notes', 'One line description of project.',
     'Miscellaneous'),
]
