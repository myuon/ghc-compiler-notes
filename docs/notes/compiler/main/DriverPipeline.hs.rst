...
`[note link] <https://gitlab.haskell.org/ghc/ghc/tree/master/compiler/main/DriverPipeline.hs#L1560>`__
...
`[note link] <https://gitlab.haskell.org/ghc/ghc/tree/master/compiler/main/DriverPipeline.hs#L2032>`__
